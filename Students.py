class Student:
    ...
    def __lt__(self, other):
        if not isinstance(other, Student):
            print("не сравниваем такие вещи.")
            return
...
student_01 = Student('Alexandr', 'Sapogov', 'Male')
student_01.courses_in_progress += ['Python', 'GIT']
student_01.finished_courses += ['C++']

student_02 = Student('Ruoy', 'Eman', 'Female')
student_02.courses_in_progress += ['Python', 'C+']
student_02.finished_courses += ['Java', 'GIT']
...
student_02.rate_lect(lecturer_01, 'Python', 9)
student_02.rate_lect(lecturer_02, 'Python', 10)
